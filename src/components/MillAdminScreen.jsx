          ...
          {!scannedTruck ? (
            ...
            <div style={{ width: '100%', flex: 1, display: 'flex', flexDirection: 'column' }}>
              <div style={{ padding: 16, background: 'rgba(255,255,255,0.03)', borderRadius: 16, marginBottom: 20 }}>
                ...
                <p className="text-display c-white" style={{ fontSize: 32, marginBottom: 16 }}>{scannedTruck.plate_number}</p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  ...
                  <div>
                    ...
                    <p className="text-body-lg c-white">{scannedTruck.tonnage} Ton</p>
                  </div>
                </div>
              </div>
              ...
              filteredTrucks.map(truck => {
                ...
                return (
                  <div key={truck.id} style={{ 
                    ...
                    <div>
                      <p className="text-body-lg c-white" style={{ fontWeight: 700 }}>{truck.plate_number}</p>
                      <p className="text-caps c-on-surface-var" style={{ fontSize: 10 }}>{truck.driver_name} • {truck.tonnage} Ton</p>
                      {schedule && (
